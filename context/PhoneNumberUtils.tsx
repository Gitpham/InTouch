...
const invalidAreaCodes = [
  200, 211, 221, 222, 230, 232, 233, 237, 238, 241, 243, 244, 245, 247, 255,
  258, 259, 261, 265, 266, 271, 273, 275, 277, 278, 280, 282, 285, 286, 287,
  288, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 311, 322, 328,
  333, 335, 338, 342, 344, 348, 349, 355, 356, 358, 359, 362, 366, 370, 371,
  372, 373, 374, 375, 376, 377, 378, 379, 381, 383, 384, 387, 388, 389, 390,
  391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 411, 420, 421, 422, 426,
  427, 429, 433, 439, 444, 446, 449, 451, 452, 453, 454, 455, 459, 460, 461,
  462, 465, 466, 467, 471, 476, 477, 481, 482, 485, 486, 487, 488, 489, 490,
  491, 492, 493, 494, 495, 496, 497, 498, 499, 511, 535, 536, 537, 538, 542,
  543, 545, 546, 547, 549, 550, 552, 553, 554, 555, 556, 558, 560, 565, 568,
  569, 576, 578, 583, 589, 590, 591, 592, 593, 594, 595, 596, 597, 598, 599,
  611, 625, 627, 632, 633, 634, 635, 637, 638, 642, 643, 644, 648, 652, 653,
  654, 655, 663, 665, 666, 668, 673, 674, 675, 676, 677, 685, 687, 688, 690,
  691, 692, 693, 694, 695, 696, 697, 698, 699, 711, 722, 723, 733, 735, 736,
  739, 741, 744, 745, 746, 749, 750, 751, 752, 755, 756, 759, 761, 764, 766,
  768, 776, 777, 783, 788, 789, 790, 791, 792, 793, 794, 795, 796, 797, 798,
  799, 811, 823, 824, 827, 834, 836, 837, 841, 842, 846, 851, 852, 853, 871,
  874, 875, 880, 881, 882, 883, 884, 885, 886, 887, 889, 890, 891, 892, 893,
  894, 895, 896, 897, 898, 899, 911, 921, 922, 923, 926, 927, 932, 933, 935,
  944, 946, 950, 953, 955, 957, 958, 960, 961, 962, 963, 964, 965, 966, 967,
  968, 969, 974, 976, 977, 981, 982, 987, 990, 991, 992, 993, 994, 995, 996,
  997, 998, 999,
];
...
function phoneNumberVerifier(phoneNumber: string): boolean {
  if (phoneNumber.length < 10) {
    Alert.alert(
      ...
      "Please Enter 3-digit area and 7-digit phone number"
    );
    return false;
  }
  ...
  if (areaCode in invalidAreaCodes) {
    Alert.alert(
      "Invalid Phone Number",
      "You have entered an invalid area code"
    );
    return false;
  }
